...
image_paths = [
    "/path/to/Exposure1_1.png",
    "/path/to/Exposure1_2.png",
    "/path/to/Exposure2_1.png",
    "/path/to/Exposure2_2.png",
    "/path/to/Exposure3_1.png",
    "/path/to/Exposure3_2.png",
    "/path/to/Exposure4_1.png",
    "/path/to/Exposure4_2.png",
    "/path/to/Exposure5_1.png",
    "/path/to/Exposure5_2.png",
]
...
#exposure_times = np.array([10, 20, 40, 80, 160, 320, 640, 800, 1000, 2000, 5000], dtype=np.float32)  # in milliseconds
